...
| `routing_padding`             | number (default: 24)                        | _(Advanced)_ Adjust obstacle clearance for this arrow                   |
| `port_clearance`              | number                                      | _(Advanced)_ Adjust first-segment offset from node edge                 |
