...
metadata:
  {
    "openclaw":
      {
        "requires": { "anyBins": ["draw.io", "drawio"] },
        "emoji": "📐",
    ...
    "hermes":
      {
        "tags": ["drawio", "diagram", "flowchart", "architecture", "visualization", "uml"],
        "category": "design",
        "requires_tools": ["draw.io"],
        "related_skills": ["mermaid", "excalidraw", "plantuml"],
      },
    "author": "Agents365-ai",
    "version": "1.5.2",
  }
