...
import {
  DevProjectCreateRequestSchema,
  DevProjectListRequestSchema,
  DevProjectInspectRequestSchema,
  DevProjectUpdateRequestSchema,
  DevProjectDeleteRequestSchema,
  DevProjectBranchStatusListRequestSchema,
  DevProjectCicdConfigureRequestSchema,
  DevProjectCicdStatusRequestSchema,
  DevProjectCicdTriggerBuildRequestSchema,
  DevProjectCicdBuildStatusRequestSchema,
  DevTaskCreateRequestSchema,
  DevTaskListRequestSchema,
  DevTaskInspectRequestSchema,
  DevTaskUpdateRequestSchema,
  DevTaskDeleteRequestSchema,
  DevTaskAssignAgentRequestSchema,
  DevTaskSetActiveAgentRequestSchema,
  DevTaskLinkAgentRequestSchema,
  DevTaskSetInteractionModeRequestSchema,
  DevTaskAddContextRequestSchema,
  DevTaskRemoveContextRequestSchema,
  DevTaskSuggestSplitRequestSchema,
  DevTaskConfirmSplitRequestSchema,
  DevTaskToggleZentaoSyncRequestSchema,
  DevTaskMergeToUatRequestSchema,
  DevTaskMergeToProductionRequestSchema,
  DevTaskResolveMergeConflictRequestSchema,
  DevTaskSetBranchRequestSchema,
  DevTaskArchiveRequestSchema,
  DevTaskActivityListRequestSchema,
  DevContextListRequestSchema,
  DevContextAddRequestSchema,
  DevContextRemoveRequestSchema,
  DevSkillListRequestSchema,
  DevSkillAddRequestSchema,
  DevSkillRemoveRequestSchema,
  DevSkillUpdateRequestSchema,
  DevDefaultConfigListRequestSchema,
  DevDefaultConfigUpdateRequestSchema,
  DevZentaoConfigureRequestSchema,
  DevZentaoConfigureStatusRequestSchema,
  DevZentaoSyncPushRequestSchema,
  DevZentaoSyncPullRequestSchema,
  DevZentaoSyncBidirectionalRequestSchema,
  ...
  DevProjectDeleteResponseSchema,
  DevProjectBranchStatusListResponseSchema,
  DevProjectCicdConfigureResponseSchema,
  DevProjectCicdStatusResponseSchema,
  DevProjectCicdTriggerBuildResponseSchema,
  DevProjectCicdBuildStatusResponseSchema,
  DevTaskCreateResponseSchema,
  DevTaskListResponseSchema,
  DevTaskInspectResponseSchema,
  DevTaskUpdateResponseSchema,
  DevTaskDeleteResponseSchema,
  DevTaskAssignAgentResponseSchema,
  DevTaskSetActiveAgentResponseSchema,
  DevTaskLinkAgentResponseSchema,
  DevTaskSetInteractionModeResponseSchema,
  DevTaskAddContextResponseSchema,
  DevTaskRemoveContextResponseSchema,
  DevTaskSuggestSplitResponseSchema,
  DevTaskConfirmSplitResponseSchema,
  DevTaskToggleZentaoSyncResponseSchema,
  DevTaskMergeToUatResponseSchema,
  DevTaskMergeToProductionResponseSchema,
  DevTaskResolveMergeConflictResponseSchema,
  DevTaskSetBranchResponseSchema,
  DevTaskArchiveResponseSchema,
  DevTaskActivityListResponseSchema,
  DevContextListResponseSchema,
  DevContextAddResponseSchema,
  DevContextRemoveResponseSchema,
  DevSkillListResponseSchema,
  DevSkillAddResponseSchema,
  DevSkillRemoveResponseSchema,
  DevSkillUpdateResponseSchema,
  DevDefaultConfigListResponseSchema,
  DevDefaultConfigUpdateResponseSchema,
  DevZentaoConfigureResponseSchema,
  DevZentaoConfigureStatusResponseSchema,
  DevZentaoSyncPushResponseSchema,
  DevZentaoSyncPullResponseSchema,
  DevZentaoSyncBidirectionalResponseSchema,
...
// Wrapped session message — explicit type annotation needed because the
// discriminated union exceeds TypeScript's type-serialization length limit.
export const WSSessionInboundSchema: z.ZodObject<{
  type: z.ZodLiteral<"session">;
  message: z.ZodDiscriminatedUnion<
    "type",
